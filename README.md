...
6. Run the **GameGUI** class as a Java Application and blast off! **OR** Run the **TextBasedGameGUI** to run the Text-Based version of the game. Explained further in the **Text-Based Version** section below.
