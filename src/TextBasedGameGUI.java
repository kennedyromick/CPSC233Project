...
public class TextBasedGameGUI {
	...
	public static void main(String[] args) {
		...
		TextBasedObstacle o1 = new TextBasedObstacle(2,4);
		...
		obstacles.add(o3);
		TextBasedObstacle o4 = new TextBasedObstacle(7,8);
		frame[o4.getRow()][o4.getColumn()] = '*';
		obstacles.add(o4);
		TextBasedObstacle o5 = new TextBasedObstacle(4,7);
		frame[o5.getRow()][o5.getColumn()] = '*';
		obstacles.add(o5);
		TextBasedObstacle o6 = new TextBasedObstacle(3,9);
		...
		while(ascii != 101 && ascii != 1) {
			...
			if(ascii == 100) {
				...
				avatar.right();
				for(TextBasedEnemies e: enemies) {
					if(avatar.collisionCheck(e) == true) {
						done = true;
					}
					e.move();
					frame[e.getRow()][e.getColumn()] = '#';
